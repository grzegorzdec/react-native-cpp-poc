...
- (id)initWithCpp:(const std::shared_ptr<::hellofromcpp::HelloWorld>&)cppRef;

@end

@implementation HWHelloWorld {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::hellofromcpp::HelloWorld>> _cppRefHandle;
}
...
+ (nullable HWHelloWorld *)create {
    try {
        auto objcpp_result_ = ::hellofromcpp::HelloWorld::create();
